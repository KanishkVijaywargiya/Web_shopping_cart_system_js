...
const client = contentful.createClient({
    ...
    accessToken: "jCZ9xShbsGO4O4_u3WpUpVutLdrbNCYMESeK702TDnw"
});
    ...
    getBagButtons() {
        ...
        buttons.forEach(button => {
            ...
            button.addEventListener('click', (event) => {
                ...
                let cartItem = { ...Storage.getProducts(id), amount: 1 };   //amount is added to control the qty. of products.
